...
onready var _btn_set_map := $FontSelection/RightPane/Buttons/Grid/BtnSetFontMap
onready var _btn_set_om := $FontSelection/RightPane/Buttons/Grid/BtnSetFontOvermap
onready var _btn_set_all := $FontSelection/RightPane/Buttons/Grid/BtnSetFontAll
