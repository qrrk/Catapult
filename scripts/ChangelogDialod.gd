...
const _PR_URL = {
    ...
    "eod": "https://https://api.github.com/search/issues?q=repo%3Aatomicfox556/Cataclysm-EOD",
	"TISH": "https://https://api.github.com/search/issues?q=repo%3Acataclysm-tish-team/Cataclysm-TISH",
}
